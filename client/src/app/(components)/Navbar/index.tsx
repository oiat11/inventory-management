    ...
    <div className="flex justify-between items-center w-full mb-7">
      ...
      <div className="relative">
        <input
          ...
          className="pl-10 pr-4 py-2 w-50 md:w-80 border-gray-300 bg-white rounded-lg focus:outline-none focus:norader-blue-500"
        />
      ...
      <div className="flex justify-between items-center gap-5">
        ...
        <Link href="/settings">
        <Settings className="cursor-pointer text-gray-500" size={24}></Settings></Link>
      </div>
    </div>
  );
};
